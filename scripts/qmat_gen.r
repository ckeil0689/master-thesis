...
if(opt == "chip") {
  orig_matpath <- paste0(getwd(), "/chipseq/", "C_Th17_mat.txt")
  ranked_matpath <- paste0(getwd(), "/chipseq/", "C_Th17_mat_ranked.txt")
  
} else if(opt == "deseq") {
  orig_matpath <- paste0(getwd(), "/deseq/", "K_Th17_mat.txt")
  ranked_matpath <- paste0(getwd(), "/deseq/", "K_Th17_mat_ranked.txt")
  
} else if(opt == "rna") {
  orig_matpath <- paste0(getwd(), "/inferelator/", "GSE40918_Inferelator_RNAseq.txt")
  ranked_matpath <- paste0(getwd(), "/inferelator/", "GSE40918_Inferelator_RNAseq_ranked.txt")
  
} else if(opt == "immgen") {
  orig_matpath <- paste0(getwd(), "/inferelator/", "GSE40918_Inferelator_Immgen.txt")
  ranked_matpath <- paste0(getwd(), "/inferelator/", "GSE40918_Inferelator_Immgen_ranked.txt")
...
convert_q <- function(orig_matpath, ranked_matpath) {
  ...
  analysis_dir <- paste0(getwd(), "/analysis/")
  if(!dir.exists(analysis_dir)) {
    dir.create(analysis_dir)
  }
  
  filename=paste0(analysis_dir, matname[[1]][1], "_q.txt")
