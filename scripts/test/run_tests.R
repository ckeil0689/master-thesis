...
main.dir <- paste0(getwd(), "/../main/")
source(paste0(main.dir, "addLibraries.R"))
...
source(paste0(getwd(), "/../main/setGlobalVars.R"))
...
source(paste0(main.dir, "utility.R")) # if needed before source'd in master.R (write.mat etc.)
